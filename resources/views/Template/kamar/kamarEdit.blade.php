...
<body class="bg-gray-100 p-6">
    ...
    <div class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-green-700 mb-1">Edit Kamar</h1>
            <p class="text-sm text-gray-600">Silakan edit data kamar di bawah ini.</p>
        </div>
    ...
    <div class="mb-4">
        ...
        <input type="text" name="nama" id="nama" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-green-500 focus:border-green-500" value="{{ old('nama', $kamar->nama) }}" required>
        @error('nama')
