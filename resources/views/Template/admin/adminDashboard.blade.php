...
<div class="relative bg-yellow-50 rounded-xl shadow-inner text-center mb-8 overflow-hidden">
    ...
    <div class="relative p-6 z-10">
        <h1 class="text-3xl font-bold text-yellow-500 mb-2">SELAMAT DATANG ADMIN</h1>
        <p class="text-gray-800 font-medium">Anda Berhasil Login sebagai Admin!</p>
    </div>
</div>
            <!-- Action Cards -->
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                <a href="{{ route('template.admin.beritaData') }}" class="bg-green-500 hover:bg-green-600 text-white p-6 rounded-2xl text-center font-semibold shadow-md transition transform hover:scale-105">
                    Berita
                </a>
                <a href="{{ route('template.admin.datasantri') }}" class="bg-green-500 hover:bg-green-600 text-white p-6 rounded-2xl text-center font-semibold shadow-md transition transform hover:scale-105">
                    Data Santri
                </a>
                <a href="{{ route('template.admin.dataust') }}" class="bg-green-500 hover:bg-green-600 text-white p-6 rounded-2xl text-center font-semibold shadow-md transition transform hover:scale-105">
                    Data Ustadz
                </a>
                <a href="{{ route('template.admin.dataPetugas') }}" class="bg-green-500 hover:bg-green-600 text-white p-6 rounded-2xl text-center font-semibold shadow-md transition transform hover:scale-105">
                    Data Petugas
                </a>
