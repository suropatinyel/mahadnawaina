    ...
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
        ...
        <form class="space-y-4">
            ...
            <div>
                ...
                <input type="password" name="confirmedPassword" class="mt-1 block w-full px-2 h-8 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-green-700">
            </div>
            <div>
                <button type="submit" class=" w-full mt-3 bg-yellow-500 text-white py-2 rounded-md shadow-sm hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500">Sign In</button>
            </div>
            <div>
